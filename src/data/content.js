export const services = [
  { number: '01', title: 'Event Production', text: 'From first idea to final cue, we shape events that feel effortless and alive.' },
  { number: '02', title: 'Entertainment', text: 'Performances, programming and audience energy designed around the moment.' },
  { number: '03', title: 'Media Production', text: 'Photography, films, reels and visual stories that keep the experience moving.' },
...
export const team = [
  { name: 'Rahul R S', role: 'Founder & Chief Executive Officer', initials: 'RR' },
  { name: 'Tamilselvan', role: 'Founder & Chief Operating Officer', initials: 'TS' },
  { name: 'Siva', role: 'Co-Founder & Managing Director', initials: 'S' },
  { name: 'Harish', role: 'Co-Founder & Director of Events', initials: 'H' },
]
