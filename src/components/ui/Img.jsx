...
function fallbackSVG(label = '') {
  ...
  <defs>
    <linearGradient id="b" x1="0" y1="0" x2="1" y2="1">
      <stop offset="0%" stop-color="#03251C"/><stop offset="55%" stop-color="#043A2B"/><stop offset="100%" stop-color="#043A2B"/>
    </linearGradient>
  </defs>
  ...
  <text x="400" y="372" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" letter-spacing="3" fill="#F0D883">${safe}</text>
</svg>`
