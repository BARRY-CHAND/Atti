...
function Events() {
  return (
    <>
      <Seo
        title="Events & Experiences | ATRI VERSE"
        description="From cultural celebrations and performances to event coordination and execution, ATRI VERSE creates and contributes to experiences that bring people together."
        path="/events"
      />
      <PageHeader
        eyebrow="Events"
        ...
        subtitle="From cultural celebrations and performances to event coordination and execution, ATRI VERSE creates and contributes to experiences that bring people together."
      />
