...
const TIMELINE = [
  {
    title: 'The Beginning',
    desc: 'ATRI VERSE began as a college-based creative initiative built around talent and entertainment.',
  },
  {
  ...
  {
    title: 'Growth',
    desc: 'ATRI VERSE continues to build its portfolio, network, collaborations and digital presence.',
  },
]
      ...
      <div className="container grid-2">
        <div>
          ...
          <Reveal dir="up" delay={100}>
            <p style={{ color: 'var(--text-muted)' }}>
              {`ATRI VERSE Entertainment & Productions is a multi-disciplinary creative organization working
        ...
        <Reveal dir="right" delay={150}>
          <Img
            ...
            alt="The people and creative work of ATRI VERSE"
            aspect="4 / 3"
      ...
      <div className="container grid-2">
        ...
        <Reveal dir="left" delay={120}>
          <p style={{ color: 'rgba(255,255,255,0.82)', fontSize: '1.05rem' }}>
            ATRI VERSE aims to become a recognized entertainment and production platform that
    ...
    <section className="section">
      <div className="container">
        <SectionHeading
          ...
          subtitle="Eight commitments that guide how ATRI VERSE organizes, creates and grows."
        />
    ...
    <section className="section">
      <div className="container">
        <SectionHeading
          ...
          subtitle="The founders who set the direction, the standards and the culture of ATRI VERSE."
        />
...
function About() {
  return (
    <>
      <Seo
        title="About ATRI VERSE | Talent, Creativity & Opportunity"
        description="ATRI VERSE Entertainment & Productions is a multi-disciplinary creative organization working across entertainment, media production, event management and creative services."
        path="/about"
      />
      <PageHeader
        eyebrow="About Us"
        crumb="About"
        title="ABOUT ATRI VERSE"
