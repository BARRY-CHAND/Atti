...
function Productions() {
  return (
    <>
      <Seo
        title="Media & Productions | ATRI VERSE"
        description="Photography, videography, editing, reels, event aftermovies, promotional videos, short films, scriptwriting and direction by ATRI VERSE."
        path="/productions"
      />
      <PageHeader
        eyebrow="Productions"
