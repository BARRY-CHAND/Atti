...
function Upcoming() {
  return (
    <>
      <Seo
        title="Upcoming | What's Next — ATRI VERSE"
        description="Upcoming events, productions, collaborations and opportunities from ATRI VERSE Entertainment & Productions."
        path="/upcoming"
      />
      <PageHeader
        eyebrow="Upcoming"
