...
function Work() {
  ...
  return (
    <>
      <Seo
        title="Our Work | Portfolio — ATRI VERSE"
        description="A portfolio of entertainment, events, production, creative and media work by ATRI VERSE Entertainment & Productions."
        path="/work"
      />
      <PageHeader
        eyebrow="Our Work"
